...
from objections.views import administrative_tasks, serviceprovider_list, home_page, serviceprovider_detail, serviceprovider_update, serviceprovider_delete, serviceprovider_create
